...
<script language="javascript">
    ...
    console.info(Thislink);   
    var app = app || {};
    app.wechat = function(){};
    app.wechat.sharecontent = {title: "炫于形 强于'芯'",
                               desc:"罗技G102 Prodigy游戏鼠标，真正的S7上分神器，惊喜尽在天猫双11！",
                               titleformoment:"炫于形 强于'芯' ，罗技G102 Prodigy游戏鼠标，真正的S7上分神器，惊喜尽在天猫双11！", 
                               url: "http://wx.yyservice.cn/logitechh520161031/", 
                               icon: "http://wx.yyservice.cn/logitechh520161031/img/icon.jpg"
                            };
